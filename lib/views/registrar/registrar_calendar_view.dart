...
class RegistrarCalendarView extends StatefulWidget {
  const RegistrarCalendarView({super.key});

  @override
  State<RegistrarCalendarView> createState() => _RegistrarCalendarViewState();
}

class _RegistrarCalendarViewState extends State<RegistrarCalendarView> {
